...
appear in the log. Then log `SHAKEDOWN PASSED` and unlock auto-continue.
...
1. <CONFIRM LOCATION>
2. Verify ./loop-docs/ has SPEC/STANDARDS/GOALS/PLAN (+ state files); create any
   missing via DOC-WRITER before the first increment.
